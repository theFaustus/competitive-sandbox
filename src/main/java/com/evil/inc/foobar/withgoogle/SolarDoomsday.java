...
public class SolarDoomsday {
    public static int[] solution(int area) {
        ...
        int areaToSubtract = 0;
        while (currentArea != 0) {
            if (isSquareRoot(currentArea)) {
                integers.add(currentArea);
                areaToSubtract += currentArea;
                currentArea = area - areaToSubtract;
            } else {
                currentArea--;
            }
        }
    ...
    private static boolean isSquareRoot(final int area) {
