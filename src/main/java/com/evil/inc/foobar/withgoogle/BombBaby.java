...
public class BombBaby {
    public static String solution(String x, String y) {
        ...
        while (!(numberOfFaculaBombs.equals(BigInteger.ONE) && numberOfMachBombs.equals(BigInteger.ONE))) {
            ...
            } else if (numberOfMachBombs.compareTo(numberOfFaculaBombs) > 0 && numberOfFaculaBombs.equals(BigInteger.ONE)) {
    ...
    private static boolean isMachOrFaculaLowerThanZero(final BigInteger numberOfMachBombs, final BigInteger numberOfFaculaBombs) {
        return numberOfFaculaBombs.compareTo(BigInteger.ZERO) <= 0
                || numberOfMachBombs.compareTo(BigInteger.ZERO) <= 0;
    }

    private static boolean isMachAndFaculaSameAndNotOne(final BigInteger numberOfMachBombs, final BigInteger numberOfFaculaBombs) {
        return numberOfMachBombs.compareTo(numberOfFaculaBombs) == 0 && numberOfMachBombs.compareTo(BigInteger.ONE) != 0;
    }
}
